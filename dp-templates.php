...
add_action( 'display_posts_shortcode_output', 'display_posts_templates', 10, 2 );
function display_posts_templates( $output, $original_atts ) {
	...
	include get_stylesheet_directory().'/partials/displayposts/'.$original_atts[ "layout" ].'.php';
